...
map2 = Map.create!(name: 'Bachelor Party', city: 'Las Vegas', user_id: user2.id)

PointOfInterest.create!(name: 'Tom', category: 'Friend/Family', address: '528 Victoria', latitude: '', longitude: '', map_id: map1.id)
...
PointOfInterest.create!(name: 'Mcdonalds', category: 'Restaurants', address: '528 Victoria', latitude: 45.5221592, longitude: -73.6215761, map_id: map1.id)
