...
PointOfInterest.create!(name: 'Tom', category: 'Friends/Family', address: '210 Bd Saint-Joseph E, Montréal, QC H2T 1H6', latitude: 45.5243198, longitude: -73.5894255, map_id: map1.id)
...
PotentialLocation.create!(name: '5507 St-Dominique', address: '5507 rue St-Dominique, Montreal, QC, H2T1V5', latitude: 45.5264186, longitude: -73.6001531, map_id: map1.id)
PotentialLocation.create!(name: '21 St-Viateur Est', address: '21 rue St-Viateur Est, Montreal, QC, H2T1A5', latitude: 45.5262563, longitude: -73.6014215, map_id: map1.id)
PotentialLocation.create!(name: '5751 Clark', address: '5751 rue Clark, Montreal, QC, H2T2V5', latitude: 45.5267046, longitude: -73.6028031, map_id: map1.id)
